...
public class ContaController implements ContaRepository {
	...
	public void deletar(int numero) {
		...
		if (conta != null) {
			...
			System.out.print("A Conta numero: " + numero + " não foi encontrada!");
	}
	...
	public void sacar(int numero, float valor) {
		...
		if (buscaConta != null) {
			...
			if (listaContas.get(listaContas.indexOf(buscaConta)).sacar(valor) == true)
				System.out.print("O saque na Conta número: " + numero + " foi efetuado com sucesso!");
		} else
			System.out.print("A Conta número: " + numero + " não foi encontrada!");
	}
	...
	public void depositar(int numero, float valor) {
		...
		if (buscaConta != null) {
			...
			System.out.print("O depósito na Conta número: " + numero + " foi efetuado com sucesso!");
		} else
			System.out.print("A Conta número: " + numero + " não foi encontrada ou a Conta destino não é uma Conta Corrente!");		
	}
	...
	public void transferir(int numeroOrigem, int numeroDestino, float valor) {
		...
		if (buscaContaOrigem != null && buscaContaDestino != null) {
			...
			if (listaContas.get(listaContas.indexOf(buscaContaOrigem)).sacar(valor) == true) {
				...
				System.out.print("A Transferência foi efetuado com sucesso!");
			}
		} else
			System.out.print("A Conta de Origem e/ou Destino não foram encontradas!");
	}
